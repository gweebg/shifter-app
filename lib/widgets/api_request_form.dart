...
class _RequestFormState extends State<RequestForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: _formKey,
      child: Padding(
        padding: EdgeInsets.symmetric(vertical: 20, horizontal: screenSize.width / 4),
        child: Column(

          children: [

            FormLabelElement(text: "Select your course :", fontSize: 20, color: brown),
            _buildCourseName(),
            const SizedBox(height: 14),

            FormLabelElement(text: "Select a year :", fontSize: 20, color: brown),
            _buildCourseYear(),
            const SizedBox(height: 14),

            FormLabelElement(text: "Select week date :", fontSize: 20, color: brown),
            _buildWeekDate(),
            const SizedBox(height: 14),
            ...
            FormLabelElement(text: "Select your shifts :", fontSize: 20, color: brown),
            PaginatedDataTable(
              source: _data,
              columns: const [
                ...
                ConstrainedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ButtonStyle(
                        ...
                        shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: blue),))
                    ),
