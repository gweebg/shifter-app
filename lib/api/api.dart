...
class ManagerAPI {
  ...
  getJson(String courseName, int year, String weekDate, [shifts]) async {
    ...
    http.Response response = await http.post(Uri.parse(fullUrl), body: jsonEncode(data), headers: _setHeaders());
...
void main() {
  ...
  caller.getExcel("Licenciatura em Engenharia Informática", 2, "12-05-2022", shifts);
